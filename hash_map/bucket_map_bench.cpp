//
// Created by jiahua on 2019/10/15.
//
...
int main() {
    ...
    auto average_time = std::accumulate(time.begin(), time.end(), 0ull) / time.size();
    auto throughput = (double) TOTAL / (double) average_time;
